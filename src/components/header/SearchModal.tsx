...
function SearchModal({ id, searchId, modalOpen, setModalOpen }: Props) {
  ...
  return (
    <>
      <Transition className="fixed inset-0 bg-slate-900 bg-opacity-30 z-50 transition-opacity" show={modalOpen} enter="transition ease-out duration-200" enterStart="opacity-0" enterEnd="opacity-100" leave="transition ease-out duration-100" leaveStart="opacity-100" leaveEnd="opacity-0" aria-hidden="true" appear={undefined} />
          ...
          <div className="py-4 px-2">
            <div className="mb-3 last:mb-0">
              ...
              <ul className="text-sm">
                <li>
                  <Link href="" className="flex items-center p-2 text-slate-800 hover:text-white hover:bg-indigo-500 rounded group"  onClick={() => setModalOpen(!modalOpen)}>
