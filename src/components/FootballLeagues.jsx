import { MdOutlineMoreHoriz, MdFilterList } from "react-icons/md";
      ...
      <div>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            <button className="hover:bg-gray-200 text-sm font-semibold text-gray-400 ml-4 px-2 py-2 rounded-full hover:bg-gray-300 transition duration-200">
        ...
        <div className="mt-4 border rounded">
          {leagues.map((league) => (
            <div
              key={league.name}
              className="flex justify-between items-center pl-8 py-2 border-b "
            >
              <div className="flex items-center">
                <span className="px-3 py-1">
                  <Image src={league.logo} width={40} height={40} />
                </span>
                <div className="pr-24">
                  <p className="text-sm leading-6 font-semibold text-gray-900 ml-2">
                    {league.name}
                  </p>
                  <p className="text-xs leading-6 font-semibold text-gray-400 ml-2">
                    {league.country}
                  </p>
                </div>
              </div>
